export type IFriendStatus = 'friends' | 'requests' | 'followers' | 'sent-requests' | 'following';
...
export declare enum MessageStatusComplaints {
    Add = 0,
    Reject = 1,
    Approved = 2,
    Resotred = 3,
...
export type NotificationType = 'news' | 'edit' | 'message' | 'comment' | 'animeupdate' | 'review' | 'friend' | 'viewingorderupdate';
