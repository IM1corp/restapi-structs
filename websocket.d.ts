import { IBloggerJson, IBloggerVideoFullJson, ICollectionJson, INotificationJson, IOneAnimeJson, IOneMessageJson, IPostJson, IReviewFullJson, IUserJsonFull } from "./database";
